...
# The count_users function recursively counts 
# the amount of users that belong to a group in 
# the company system, by going through each of the 
# members of a group and if one of them is a group, 
